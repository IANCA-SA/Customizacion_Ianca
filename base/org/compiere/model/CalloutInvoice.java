...
public class CalloutInvoice extends CalloutEngine
{
	...
	/**
	 * Change By Jorge Colmenarez 2014-04-08 
	...
	public String docType (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value)
	{
		...
		String sql = "SELECT d.HasCharges,'N',d.IsDocNoControlled," // 1..3
			...
			+ "d.IsManual, d.IsSOTrx " //9..10 Add by Jorge Colmenarez 2014-04-08
	...
	/** End Change By Jorge Colmenarez 2014-04-08 **/
	...
	public String product (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value)
	{
		...
		System.err.println("PriceList " + pp.getPriceList());
		System.err.println("PriceLimit " + pp.getPriceLimit());
		System.err.println("PriceActual " + pp.getPriceStd());
		System.err.println("PriceEntered " + pp.getPriceStd());
		System.err.println("C_Currency_ID " + new Integer(pp.getC_Currency_ID()));
