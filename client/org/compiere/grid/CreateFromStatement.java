	...
	public boolean save(IMiniTable miniTable, String trxName)
	{
		...
		for (int i = 0; i < miniTable.getRowCount(); i++)
		{
			if (((Boolean)miniTable.getValueAt(i, 0)).booleanValue())
			{
				...
				/*Inicio Carlos Parada Fecha de Contabilizacion igual que la fecha de el estado de cuentas
				 * Fecha:30/01/2011*/
				bsl.setDateAcct(bs.getStatementDate());
				/*Fin Carlos Parada Fecha de Contabilizacion igual que la fecha de el estado de cuentas*/
				if (!bsl.save())
