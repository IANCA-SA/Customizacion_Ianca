...
public class VPaySelect extends PaySelect implements FormPanel, ActionListener, TableModelListener, ASyncProcess
{
	...
	private void loadBankInfo()
	{
		...
		//Carlos Parada 11/05/2012 Se Agrega el Campo Disponible
		labelBalance.setText(m_format.format(bi.Balance)+ " , Disponible : "+m_format.format(bi.Available));
		//Fin Carlos Parada
		//  PaymentRule
	...
	//	m_isLocked = false;
		...
		//	Yamel Senih 27/04/2011, 18:11
		//	Se quita la pregunta sobre Imprimir y exportar pagos
		...
		//	17/05/2011,	9:52
		ADialog.ask(0, panel, Msg.translate(Env.getCtx(), "SGVPaySelect") + 
				" N°: " + m_ps.getC_PaySelection_ID() +
				"\n(" + pi.getSummary() + ")"  );
