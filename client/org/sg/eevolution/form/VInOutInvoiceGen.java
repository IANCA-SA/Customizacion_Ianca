 ...
 * Copyright (C) 2003-2007 e-Evolution,SC. All Rights Reserved.               *
  *****************************************************************************/
package org.sg.eevolution.form;
		...
		ChangeListener, TableModelListener, ASyncProcess
{
	...
	private void generateShipments_complete (ProcessInfo pi)
	{
		...
		/*
		 * Modificado por: Yamel Senih 31/03/2011
		 * Para evitar que la entrega se imprima al 
		 * momento de generar las facturas y entregas al mismo tiempo
		 * */
	...
	private void generateInvoice_complete (ProcessInfo pi)
	{
		...
		/*
		 * Modificado por: Yamel Senih 08/04/2011 14:02
		 * Para enviar las facturas a la impresora directamente 
		...
		//	info.append("\n\n" + Msg.getMsg(Env.getCtx(), "PrintInvoices"));
			...
			/*
			 * Modificado por: Yamel Senih 09/04/2011 12:25
			 * para evitar que al usuario
			 * se le pregunte si la impresión esta correcta
			 */
